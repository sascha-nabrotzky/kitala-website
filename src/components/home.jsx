...
function Home() {
    ...
    return (
      ...
      <Helmet>
        <title>Über den Verein | KiTaLa e.V. - Kindertagespflege Ladbergen</title>
      ...
      <main className={homeStyles.homeMain}>
        ...
        <p>Auch ist uns wichtig, dass sie als Eltern mehr Informationen über die Arbeit der Kindertagespflegepersonen durch Veranstaltungen und Herausgabe und Bereitstellung von Informationsmaterial bekommen.</p>

        <aside>
          <h3>Anmeldungen zur Tagespflege</h3>
          <p>Anmeldungen Ihrer Kinder zur Tagespflege erfolgen online über das Elternportal &bdquo;Step&rdquo;.
