        ...
        <div className={headerStyles.gradient}>
         ...
         <nav className={headerStyles.navigation}>
            <ul className={headerStyles.navList}>
                ...
                <li className={headerStyles.liItem}>
                    <Link to="/blog"><img src={iconCalendarGallery} alt="Icon Home"/></Link>
                </li>
                <li className={headerStyles.liItem}>
                    <Link to="/mitglieder"><img src={iconUsers} alt="Icon Users"/></Link>
                </li>
                <li className={headerStyles.liItem}>
                    <Link to="/inklusion"><img src={iconInklusion} alt="Icon Inklusion"/> </Link>
                </li>
                <li className={headerStyles.liItem}>
                    <Link to="/faq"><img src={iconBook} alt="Icon Book"/></Link>
                </li>
                <li className={headerStyles.liItem}>
                    <Link to="/download"><img src={iconDownload} alt="Icon Download"/></Link>
                </li>
            </ul>
        </nav>
